<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditInsertTipo2.aspx.cs" Inherits="PokeTCC.Tipo2.EditInsertTipo2" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <h2>Edit Tipo2</h2>
    <asp:Table ID="tbTipo2" runat="server" BackColor="Red">
        <asp:TableRow ID="trIdTipo2" runat="server" >
            <asp:TableCell><label ID="lbIdCliente">IdTipo2:</label></asp:TableCell>
            <asp:TableCell><asp:TextBox ID="txtIdTipo2" runat="server" Enabled="False" Width="320px"></asp:TextBox></asp:TableCell>
